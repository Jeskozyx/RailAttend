...
<div x-data="{ show: true }" 
    ...
    <div class="bg-white rounded-2xl shadow-2xl border-l-4 border-red-500 overflow-hidden">
        <div class="p-5">
            <div class="flex items-start">
                ...
                <div class="ml-4 flex-1">
                    <h3 class="text-lg font-bold text-gray-900 mb-1">Gagal!</h3>
        ...
        <div class="h-1 bg-gray-100">
            <div class="h-full bg-gradient-to-r from-red-400 to-red-600 animate-progress"></div>
        </div>
    </div>
</div>
