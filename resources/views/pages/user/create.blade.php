    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex items-center space-x-3 sm:space-x-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Data User</h1>
                    <p class="mt-1 text-xs sm:text-sm text-gray-500">Isi form di bawah untuk menambah user baru</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
                    ...
                    <!-- Konfirmasi Password -->
                    <div>
                        <label for="password_confirmation" class="block text-xs sm:text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" 
                                ...
                                class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <svg id="eye-password_confirmation" class="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                            </button>
                ...
                <!-- Footer Actions -->
                <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-gray-50 border-t border-gray-200 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                    <a href="{{ route('user.index') }}" class="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 border border-gray-300 rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 flex items-center justify-center space-x-2">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                        </svg>
                        <span>Batal</span>
                    </a>
                    <button type="submit" class="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg sm:rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 text-xs sm:text-sm font-medium">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
