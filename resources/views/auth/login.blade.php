...
@section('content')
    ...
    <div class="bg-gradient-to-br from-slate-50 to-white rounded-3xl shadow-2xl p-8 border border-slate-300 backdrop-blur-sm slide-up"
        ...
        <form action="{{ route('login.post') }}" method="POST" x-data="{ showPassword: false }" id="loginForm">
            @csrf
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <div
                            class="w-9 h-9 bg-gradient-to-br from-slate-100 to-slate-200 rounded-lg flex items-center justify-center">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <button type="button" @click="showPassword = !showPassword"
                        ...
                        <div
                            class="w-9 h-9 bg-slate-100 hover:bg-[#FF7300] rounded-lg flex items-center justify-center transition-all group">
                            <svg x-show="!showPassword"
                                class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors" fill="none"
